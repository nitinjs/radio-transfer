...
namespace Thornton.Scheduler.Quartz.Download
{
    public class FileShare
    {
        private void SendToFileShare(byte[] pdfData, string networkShareLocation, string fileName, string destinationPath)
        {
            var path = $"{networkShareLocation}{fileName}";
            ...
            if (ImpersonateUser(domain, userID, password) == true)
            {
                ...
                System.IO.File.Copy(path, destinationPath + "/" + fileName);
